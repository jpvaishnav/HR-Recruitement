...
def file_save():
    ...
    f = open("database/selection.dat", "ab")
    a=save(NAME_PRO,ADDRESS_PRO,MOBILE_NO_PRO)
...
class SELECTION_COMMITTEE:
    def __init__(self):
        ...
        self.Labelframe1.configure(text='''LIST OF ALL SELECTION COMMITTEE MEMBERS''')
