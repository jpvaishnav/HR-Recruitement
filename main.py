...
try:
    ...
    py3 = True
#calling functional models
def click_checkinn():
    call(["python", "applicant.py"])
def click_list():
    call(["python", "listgui.py"])
def click_checkout():
    call(["python", "selection_committee.py"])
...
class SEMINAR:
    ...
    def __init__(self):
        ...
        self.Message6.configure(text='''WELCOME TO THE SYSTEM''')
        ...
        self.Button2.configure(text='''1. APPLICANT ENTRY''')
        ...
        self.Button3.configure(text='''2. SHOW ALL APPLICANT''')
        ...
        self.Button4.configure(text='''3 . SELECTION COMMITTE DETAIL''')
        ...
        self.Button6.configure(text='''4. EXIT PORTAL''')
